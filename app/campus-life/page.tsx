/* eslint-disable @next/next/no-img-element, react/no-unescaped-entities, jsx-a11y/alt-text */
...
<button className="bg-primary text-white px-8 py-3 rounded-lg font-bold flex items-center gap-3">
