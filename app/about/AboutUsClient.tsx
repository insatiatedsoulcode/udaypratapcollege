    ...
    <main>
      ...
      <section className="bg-transparent -mt-16 relative z-10">
        <div className="container mx-auto px-4">
          <motion.div
            className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center bg-white dark:bg-slate-800 p-6 rounded-lg shadow-xl border border-gray-100 dark:border-slate-700"
          ...
          >
            {pageData.stats.map((stat, index) => (
              <div key={index} className="p-4">
                ...
                <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 mt-1">{stat.label}</p>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="bg-white dark:bg-transparent py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-10 items-center">
            ...
            >
              <div className="relative w-48 h-48 md:w-60 md:h-60 mx-auto rounded-full overflow-hidden shadow-2xl ring-4 ring-white dark:ring-slate-800 ring-offset-4 ring-offset-sky-100 dark:ring-offset-slate-900">
            ...
            >
              <h2 className="text-3xl font-bold text-gray-800 dark:text-white">A Message From The Principal</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-10 items-center">
            <motion.div
              ...
              initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={fadeInFromLeft}
            >
              <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Vision of Our Founder</h2>
              <p className="text-gray-600 dark:text-gray-300 italic">
      ...
      <section className="bg-white dark:bg-transparent py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-slate-800 dark:text-white mb-12">Our Journey</h2>
          <div className="relative before:absolute before:left-1/2 before:w-0.5 before:h-full before:bg-slate-300 dark:before:bg-slate-700 before:-translate-x-1/2">
            {pageData.historyMilestones.map((milestone, index) => (
              <motion.div key={index} className="relative mb-8" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 1 }}>
                <motion.div className="absolute left-1/2 w-4 h-4 bg-orange-500 rounded-full -translate-x-1/2 border-4 border-white dark:border-slate-900" initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true }}></motion.div>
                <div className={`flex items-center ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                  <div className={`w-5/12 ${index % 2 === 0 ? 'text-right pr-8' : 'text-left pl-8 order-2'}`}>
                    <p className="font-bold text-lg text-sky-600 dark:text-sky-400">{milestone.year}</p>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">{milestone.event}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="bg-slate-50 dark:bg-slate-800/50 py-16 md:py-24">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-slate-800 dark:text-white mb-12">Why Choose Uday Pratap College?</h2>
        <motion.div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 container mx-auto px-4" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
          {pageData.whyChooseUs.map((feature, index) => {
            ...
            return (
              <motion.div key={index} className="bg-white dark:bg-slate-800 p-6 text-center rounded-lg shadow-lg dark:shadow-none border border-gray-100 dark:border-slate-700 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group" variants={fadeInUpItem}>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center justify-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-slate-800 dark:text-white">YouTube Videos</h3>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              {pageData.videos.youtubeVideos.map((video, index) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-slate-800 rounded-lg shadow-lg dark:shadow-none border border-gray-100 dark:border-slate-700 overflow-hidden hover:shadow-xl transition-shadow duration-300"
                >
                  ...
                  <div className="p-6">
                    <h4 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">{video.title}</h4>
          ...
          >
            <div className="flex items-center justify-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-slate-800 dark:text-white">Instagram Reels</h3>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              {pageData.videos.instagramReels.map((reel, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h4 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">{reel.title}</h4>
                    <p className="text-slate-600 dark:text-slate-400">{reel.description}</p>
                    <a
          ...
          >
            <p className="text-slate-600 dark:text-slate-400 mb-6">Follow us for more updates and content</p>
