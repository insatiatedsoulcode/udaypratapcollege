...
export const metadata: Metadata = {
  ...
  description:
    'Uday Pratap College offers quality education in BA, BBA, and BCA programs. Join our prestigious institution for academic excellence, modern facilities, and career success.',
  keywords: [
    'college', 'education', 'BA program', 'BBA program', 'BCA program', 'admissions',
    'Uday Pratap College', 'higher education', 'academic excellence', 'undergraduate programs',
    'college admissions', 'educational institution', 'Varanasi college', 'Uttar Pradesh education',
    'best college Varanasi', 'college in UP', 'BA admission 2025', 'BBA admission 2025',
    'BCA admission 2025', 'college placement', 'student portal', 'online admission',
    'college facilities', 'expert faculty', 'modern education',
  ],
  ...
  alternates: { canonical: 'https://udaypratapcollege.com' },
  category: 'education',
};
